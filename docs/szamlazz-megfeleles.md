...
- **Nem fogyaszt:** a beküldés-ismétlés előtti bizonylat-lekérdezés
  ...
  zárja le (H4): a fizetés után 2 órával egy (rendelésenként fojtott) `RIASZTÁS:`, 24 órával
  `failed` + `RIASZTÁS:`, dobás nélkül, így a resweep sem kérdez le tovább. Ha a fizetés
  pillanata nem ismert, a rendelés létrehozása az időalap.
...
bejegyzést naplóz. A számla- és a helyesbítő-ágon előtte egyetlen záró lekérdezés fut: ha az
5. (bizonytalan kimenetű) beküldés mégis létrehozta a bizonylatot, a rendszer átveszi, és nem
kér kézi kiállítást (2026-09-24, H3). A stornó-ágon a kimerülés hálózati hívás nélküli. Ilyenkor a bizonylatot kézzel kell rendezni a Számlázz.hu-felületen,
