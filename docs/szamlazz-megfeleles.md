...
fizetés napja; 55/56/nem-2xx/CDATA válaszkezelés)
...
- **Nem fogyaszt:** a beküldés-ismétlés előtti bizonylat-lekérdezés
  ...
  zárja le (H4), amely a folyamatos lekérdezési hibasorozatot méri. A sorozat kezdete az
  `invoiceLastError` elején áll (`[lekérdezési hiba <időpont> óta] …`), így újraindulás után
  is megmarad; bármely sikeres lekérdezés lezárja. 2 órás sorozat után egy (rendelésenként
...
hívás nélküli. Ilyenkor a bizonylatot kézzel kell rendezni a Számlázz.hu-felületen, majd a
számot a rendelésre visszavezetni.

A számla-ág kézi rendezésre váró leállásai (H4-időkorlát, végleges lekérdezés-hiba egy
korábbi beküldés után, kimerült plafon) `invoiceLastError`-ja egységesen „A számla
