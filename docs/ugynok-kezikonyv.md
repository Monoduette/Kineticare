...
| `record:manual-invoice`                 | `record-manual-invoice.ts`               | próba; írás `OWNER_MANUAL_INVOICE_CONFIRM=igen`; a 'failed' számlájú rendelésre a kézzel kiállított számla számát rögzíti (a K12 kapu utána nyit); `docs/uzemeltetes/05-szamla-storno-helyesbito-kezi.md`                                               |
