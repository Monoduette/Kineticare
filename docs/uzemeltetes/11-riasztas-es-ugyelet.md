...
| `visszaterites-barion-elteres`                  | A Barionban más összeg ment már vissza ebből a fizetésből, mint amit a rendelés nyilvántart (a levél mindkét összeget megírja); a visszatérítés nem indult el | Ne indíts új visszatérítést, se itt, se a Barion felületén. Egyeztesd a fejlesztővel a Barion-fiók alapján: [06](06-visszaterites.md) 3. pont                                                          |
...
| `visszateritesi-ertesito-bizonytalan`           | A visszatérítés megtörtént, de nem biztos, hogy a vevő értesítője kiment (időtúllépés vagy átmeneti hiba)                                                     | Előbb keresd meg a Resend naplójában a levélben álló `refund:<azonosító>` kulcsot; csak akkor írj kézzel, ha nincs ott                                                                                 |
