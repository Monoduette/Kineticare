...
describe('FreeSos — a szótári felirat nyer a CMS-mező ellenében', () => {
  ...
  it('a KIRENDERELT kezdőlapi sávon is a szótári felirat látszik', () => {
    ...
    // A szerkesztő CÍME és SZÖVEGE változatlanul él (2026-09-22, K18: a sáv
    // címe a CMS-é, üresen az „Ingyenes villámkurzus” tartalék áll); a
    // GOMBFELIRAT viszont a szótáré, a CMS-mező nem nyomja el.
    expect(html).toContain('>Ingyenes SOS gyakorlatok</h2>')
    expect(html).not.toContain('Ingyenes villámkurzus')
