 ...
 *
 * Négy dolgot mond ki, csak ha igaz:
 ...
 *   Kapcsolat oldalon azt, ami ott valóban látszik (sectionSource);
 ...
 * - rejtett szekciónál a link HELYETT, hogy a lapon nem látszik.
 *
...
export function SectionSourceNoticeView({
  ...
  if (kotott) {
    return (
      <div className="kc-admin-notice kc-section-source">
        <p className="kc-admin-notice__cim">{KOTOTT_CIM}</p>
        {kotott}
        <Linkek model={model} />
      </div>
    )
