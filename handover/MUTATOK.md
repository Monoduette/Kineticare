...
Őr: `src/__tests__/ugynok-kezikonyv.test.ts`

Ha a kézikönyvet frissíted, másold újra ide is (`docs/ugynok-kezikonyv.md`
→ `handover/ugynok-kezikonyv.md`), különben a CI bukik.
